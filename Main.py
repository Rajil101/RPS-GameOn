...
image_rock1 = ImageTk.PhotoImage(Image.open("rock 1.jpg"))
image_paper1 = ImageTk.PhotoImage(Image.open("paper 1.jpg"))
image_scissor1 = ImageTk.PhotoImage(Image.open("scissor 1 (1).jpg"))


image_rock2 = ImageTk.PhotoImage(Image.open("rock 2.jpg"))
image_paper2 = ImageTk.PhotoImage(Image.open("paper 2.jpg"))
image_scissor2 = ImageTk.PhotoImage(Image.open("scissor 1 (2).jpg"))
